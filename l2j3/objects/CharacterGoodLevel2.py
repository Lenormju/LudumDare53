...
class CharacterGoodLevel2():
    def __init__(self):
        self.panierBaby = PanierGun(pygame.Rect(GAME_INFO.SCREEN_WIDTH/2, GAME_INFO.SCREEN_HEIGHT-100,100, 100), 15, 0, "assets/panier_baby.png")
        self.panierBaby.SetType(DropType.BABY_TYPE)
        self.panierPoop = PanierGun(pygame.Rect(GAME_INFO.SCREEN_WIDTH/2-110, GAME_INFO.SCREEN_HEIGHT-100,100, 100), 15, 0, "assets/panier_poop.png")
