...
from screens import Title, GoodLevelOne, GoodLevelTwo, GoodEnding, BadInterlude, BadLevelOne, BadLevelThree, BadEnding, NeutralEnding
...
while keep_running:
    ...
    render_function = {
        ...
        GameScreen.GOOD_LEVEL_ONE: GoodLevelTwo.render,
