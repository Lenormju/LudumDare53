...
def render(screen, events, keys, mouse_buttons: MouseButtons):
    ...
    screen.blit(comic_sans_ms.render("by L2J2R", False, granny_color), (20, 150))
    ...
    screen.blit(pygame.transform.rotate(comic_sans_ms.render("Catch", True, sky_color), 15), (390, 100))
    screen.blit(pygame.transform.rotate(comic_sans_ms.render("All", True, sky_color), 15), (420, 135))
    screen.blit(pygame.transform.rotate(comic_sans_ms.render("The", True, sky_color), 15), (420, 165))
    screen.blit(pygame.transform.rotate(comic_sans_ms.render("Babies!", True, sky_color), 15), (410, 185))
